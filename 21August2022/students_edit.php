...
<body>
    ...
    <form action="" method="post">
        <input type="number" name="id" value="<?php echo $id; ?>" placeholder="Enter ID"><br><br>
    ...
    <?php
        ...
        $sql = "SELECT * FORM students WHERE student_id = '$id'";
        $result = $db->($sql);
        $data = $result->fetch_assoc();
        if(isset($_POST['submit'])){
            extract($_POST);

            $sql = "UPDATE students SET student_id = '$id', student_name = '$name', student_email = '$email', student_phone = '$phone'";
